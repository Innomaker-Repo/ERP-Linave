...
class Levantamento(models.Model):
    ...
    negocio = models.ForeignKey(Negocio, on_delete=models.CASCADE, related_name='orcamentos') # negocio id which this orcamento is about, to be selected from a dropdown list of existing negocio entries
    ...
    def __str__(self):
        return f"Orçamento {self.id} - Negócio {self.negocio.id} - Solicitante: {self.solicitante.user_name}"
...
class Resumo_orcamento(models.Model):
    ...
    credenciais = models.ForeignKey(Levantamento, on_delete=models.CASCADE, related_name="resumo_credenciais")

    mao_de_obra = models.ForeignKey(MDO, on_delete=models.PROTECT, related_name="resumo_MDO")
